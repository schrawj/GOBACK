...
'^755.[23456][0-9][^8]', # limb.reduction.deformities
'^755.[25]', # upper.limb.reduction.deformities
'^755.[36]', # lower.limb.reduction.deformities
...
icd9.codes <- c( 
  ...
  '^75[456]', # conganomalies.musculoskeletal.sys
  '^755.[23456]', # limb.reduction.deformities
  '^755.[25]', # upper.limb.reduction.deformities
  '^755.[36]', # lower.limb.reduction.deformities
...
saveRDS(defects, 
        '//smb-main.ad.bcm.edu/genepi2/Old_genepi2/Jeremy/GOBACK/Datasets/Expanded_datasets/birth.defects.lookup.table.v20230119.rds')

write_csv(defects,
          file = '//smb-main.ad.bcm.edu/genepi2/Old_genepi2/Jeremy/GOBACK/Datasets/Expanded_datasets/birth.defects.lookup.table.v20230119.csv')
